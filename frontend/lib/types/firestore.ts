...
export interface Message {
  ...
  image_data?: string; // Base64 encoded image data for visualizations (churn analysis charts, etc.)
  visualization_type?: string; // Type of visualization (chart, graph, plot, etc.)
  metadata?: {

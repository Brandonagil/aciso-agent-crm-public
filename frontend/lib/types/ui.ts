...
export interface DisplayMessage {
    ...
    plan_data?: unknown; // PlanReActPlanner structured planning data
    // ADK-compliant streaming - no temporary message logic needed
}
...
export interface AssistantApiResponse {
    ...
    message?: string;
    image_data?: string; // Base64 encoded image data
    visualization_type?: string; // Type of visualization (chart, table, heatmap)
    plan_data?: unknown; // PlanReActPlanner structured planning data
}

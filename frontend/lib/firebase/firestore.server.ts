 ...
 * @param image_data Optional base64 image data for visualizations.
 * @param visualization_type Optional type of visualization (chart, graph, etc.).
...
export const addMessageToSession = async (
    ...
    try {
        ...
        const messageData = {
            ...
            ...(image_data && { image_data }), // Add image_data if provided
            ...(visualization_type && { visualization_type }), // Add visualization_type if provided
        };

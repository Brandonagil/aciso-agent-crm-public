...
test.describe('Retention plan card response', () => {
  test('should check retention plan cards after response', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/retention-card-response.png', fullPage: true });
    ...
    console.log('Retention plan response results');
    ...
    console.log('Retention plan response check completed.');
  });
});
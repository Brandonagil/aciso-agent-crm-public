...
export async function GET(
  ...
  try {
    ...
    console.error(`Error fetching project ${(await params).projectId}:`, error);
...
export async function PATCH(
  ...
  try {
    ...
    console.error(`Error updating project ${(await params).projectId}:`, error);
    return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`Error deleting project ${(await params).projectId}:`, error);
    return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
  }
} 